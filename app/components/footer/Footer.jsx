...
const Footer = () => {
  return (
    <>
      <div className="container mx-auto px-8 border-dashed border-t mt-16 border-[#00000040] lg:border-solid flex flex-col gap-y-9 lg:flex-row lg:justify-between">
        ...
        <div className="flex justify-between items-center lg:flex-col-reverse lg:items-end lg:justify-around">
          <div className="flex gap-y-2 gap-x-4 flex-wrap w-1/4 lg:flex-row lg:w-fit justify-evenly">
            <div className="relative w-9 h-10 lg:w-16 lg:h-20">
              <Image
                src="/images/img1.png"
                fill
            ...
            <div className="relative w-8 h-10 lg:w-16 lg:h-20">
              <Image
                src="/images/img3.png"
                fill
            ...
            <div className="relative w-8 h-10 lg:w-20 lg:h-20">
              <Image
                src="/images/img4.png"
                fill
            ...
            <div className="relative w-10 h-9 lg:w-16 lg:h-20">
              <Image
                src="/images/img5.png"
                fill
          ...
          <div className="flex flex-col gap-y-3">
            <div className="relative w-24 h-8 lg:w-36 lg:h-11">
              <Image
                className="self-end"
                alt="Torino Logo"
                src="/images/logo.png"
